...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException{
		...
		cat4.getProdutos().addAll(Arrays.asList(p1,p2));
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "36542456", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("27456986", "93875429"));
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 309", "Jardim", "3824552", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenidna Matos", "105", "Sala 309", "Centro", "3444552", cli1, c1);
		...
		Pedido ped1 = new Pedido(null, sdf.parse("11/01/2018 11:39"), cli1, e1);
		Pedido ped2 = new Pedido(null, sdf.parse("11/01/2018 11:40"), cli1, e2);
